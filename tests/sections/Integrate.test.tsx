...
describe('Integrate', () => {
	it('renders all six tabs and switches to Web Component on click', () => {
		render(<Integrate />);
		...
		expect(screen.getByRole('tab', { name: /direct signer/i })).toBeInTheDocument();
		expect(screen.getByRole('tab', { name: /^keychain$/i })).toBeInTheDocument();
